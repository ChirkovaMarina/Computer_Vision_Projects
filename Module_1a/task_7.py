...
class BirdsView(SeasonReader):
    """Process camera video and transform it into a bird's-eye-view image."""
    corner_points_array = None # Corner array for the platform where the camera is installed.
    img_params = None # Image parameters.
