...
class Quaternion:
    ...
    def vx(self):
        """Quaternion parameter: x component of the rotation vector."""
        return self._vx

    def vy(self):
        """Quaternion parameter: y component of the rotation vector."""
        return self._vy

    def vz(self):
        """Quaternion parameter: z component of the rotation vector."""
        return self._vz

    def w(self):
        """Quaternion parameter: cosine of the half-angle."""
        return self._w
