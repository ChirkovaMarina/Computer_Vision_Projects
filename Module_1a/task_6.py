...
# Overlay telemetry information on the frame.
class Telemetry(SeasonReader):
    FUSTY_COUNT = 30  # SenseData is considered stale after 30 frames and is no longer shown.
    _currentSenseData: SenseData
    _actualityDataCount: int = 31  # Track staleness and suppress outdated data.
    _addMapOnFrame: bool = True
    _addLogoOnFrame: bool = True
    # Preloaded images used for rendering.
    ...
    def put_sense_data(self):
        ...
        # Draw the SenseData timestamp marker.
