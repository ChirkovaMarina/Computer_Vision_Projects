...
class Plotter:
    ...
    def draw(img,
             ...
             scale_x=50,  # X-axis scale in pixels
             scale_y=50,  # Y-axis scale in pixels
             color=(255, 50, 50),  # graph color
             show_x_axis=True,  # show the X axis
             show_y_axis=True):  # show the Y axis
